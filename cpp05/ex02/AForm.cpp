...
AForm::AForm(const std::string& name, int grade_sign, int grade_exec) :
    name(name), boolean(false), grade_sign(grade_sign), grade_exec(grade_exec) {
...
AForm::AForm(const AForm& other) :
    name(other.name), boolean(other.boolean), grade_sign(other.grade_sign), grade_exec(other.grade_exec) {}
